        ...
        <li key={goodSingle.key}>
          <div className={s.cardGood}>
            ...
            <div className={s.flexContainer}>
              ...
              <input
                className={s.cardGood_inputName}
                type="text"
                placeholder="Name"
                value={inputName}
              ...
              {/* <>
                if(errorNameField){<p>{ errorNameField}</p>}
              </> */}

              {/* <isErrorGeneral ErrorNameMessage errorNameField={ errorNameField}/> */}

              <input
                className={s.cardGood_inputNumber}
                type="tel"
                placeholder="Number"
                value={inputNumber}
